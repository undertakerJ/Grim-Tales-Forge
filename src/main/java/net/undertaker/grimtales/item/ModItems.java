...
public class ModItems {
  ...
  public static final RegistryObject<Item> CEBBITE_LEGGINGS =
      ITEMS.register(
          ...
          () ->
              new ModArmorItem(
                  ModArmorMaterial.CEBBITE, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE)));
  public static final RegistryObject<Item> CEBBITE_CHESTPLATE =
      ITEMS.register(
          "cebbite_chestplate",
          () ->
              new ModArmorItem(
                  ModArmorMaterial.CEBBITE, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE)));
  public static final RegistryObject<Item> CEBBITE_HELMET =
      ITEMS.register(
          "cebbite_helmet",
          () ->
              new ModArmorItem(
                  ModArmorMaterial.CEBBITE, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.RARE)));
