...
public class CebbiteCombatArmor extends ArmorItem implements GeoItem {
  public CebbiteCombatArmor(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
  ...
  public void initializeClient(Consumer<IClientItemExtensions> consumer) {
    consumer.accept(
        new IClientItemExtensions() {
          private CebbiteCombatArmorRenderer renderer;
          ...
          public @NotNull HumanoidModel<?> getHumanoidArmorModel(
            ...
            if(this.renderer == null) this.renderer = new CebbiteCombatArmorRenderer();
